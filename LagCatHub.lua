...
local tabs = {
    ...
    StealABrainrot = window:AddTab({ Title = "Steal A Brainrot" }),
...
UpdateScript:AddParagraph({
    ...
    Content = [[
[+] Add some scripts.
[+] Added support for Steal a Brainrot game.
[+] Game Join Function Can Join Game Steal a Brainrot.
